...
#memberdhip operators:

x = ["Zhuma", "Aidos"]
print("Aidos" in x) # returns True because a sequence with the value "banana" is in the list

x = ["Pusha", "Baltimore"]
print("Zhuma" not in x) # returns True because a sequence with the value "pineapple" is not in the list
